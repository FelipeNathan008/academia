...
class AlunoController extends Controller
{
    ...
    public function index($responsavelId)
    {
        ...
        return view('view_admin_user.view_principal.view_alunos.index', [
    ...
    public function edit($idCriptografado)
    {
        ...
        return view('view_admin_user.view_principal.view_alunos.edit', [
            'aluno' => $aluno,
    ...
    public function show($id)
    {
        ...
        return view('view_admin_user.view_principal.view_alunos.show', compact('aluno'));
    }

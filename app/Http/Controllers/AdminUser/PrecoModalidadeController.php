...
class PrecoModalidadeController extends Controller
{
    public function index()
    {
        ...
        return view('view_admin_user.view_admin.view_preco_modalidades.index', compact('valores', 'modalidades'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('view_admin_user.view_admin.view_preco_modalidades.edit', compact('valor', 'modalidades'));
    }

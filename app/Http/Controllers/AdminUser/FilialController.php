...
class FilialController extends Controller
{
    ...
    public function index()
    {
        ...
        $empresa = Empresa::where('id_empresa', $user->id_emp_id)
            ->firstOrFail();
        return view('view_admin_user.view_controle.view_filiais.index', compact('filiais', 'empresa'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('view_admin_user.view_controle.view_filiais.edit', compact('filial', 'empresas'));
    }

...
class DetalhesFilialController extends Controller
{
    public function index($id)
    {
        ...
        return view('view_admin_user.view_controle.view_filiais.detalhes_filial', compact(
            'detalhes',
            'idFilial',
            'filial',
            'temDetalhe'
    ...
    public function edit($id)
    {
        ...
        return view('view_admin_user.view_controle.view_filiais.detalhes_filial_edit', compact('detalhe', 'filial'));
    }

...
<div class="flex justify-between items-center mb-8">
    ...
    <a href="{{ url()->previous() ?? route('professor-aulas', Crypt::encrypt($aula->gradeHorario->id_grade)) }}"
...
<div class="bg-white rounded-2xl shadow-md p-8">
    ...
    <div class="mt-10 pt-6 border-t flex justify-end gap-4">
        ...
        <a href="{{ route('professor-aulas.edit', Crypt::encrypt($aula->id_aula)) }}"
            ...
            class="px-5 py-2 rounded-lg shadow hover:bg-[#732920] transition duration-200">
            Editar
        </a>
        ...
        <form action="{{ route('professor-aulas.destroy', Crypt::encrypt($aula->id_aula)) }}"
            ...
            <button type="submit"
                ...
                class="px-5 py-2 rounded-lg shadow hover:bg-[#D65A3E] transition duration-200">
                Excluir
            </button>

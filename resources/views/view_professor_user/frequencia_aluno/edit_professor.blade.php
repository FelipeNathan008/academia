...
<div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-md p-8">
    ...
    <h2 class="text-2xl font-bold mb-6 text-gray-800">
        Editar Frequência
        ({{ \Carbon\Carbon::parse($frequencia->freq_data_aula)->format('d/m/Y') }})
    </h2>

    <form action="{{ route('professor-frequencia.update', Crypt::encrypt($frequencia->id_frequencia_aluno)) }}"
        method="POST">
        ...
        <div class="flex justify-end gap-4 mt-6">
            ...
            <a href="{{ route('professor-frequencia.dias', Crypt::encrypt($frequencia->grade_horario_id_grade)) }}"

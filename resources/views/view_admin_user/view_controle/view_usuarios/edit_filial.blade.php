...
<nav class="mb-6 text-sm text-gray-500">
    <ol class="flex items-center gap-2">
        ...
        <li>/</li>
        <a href="{{ route('usuarios.indexFilial', ['filial' => Crypt::encrypt($filial->id_filial)]) }}" class="hover:text-[#8E251F] transition">
            Usuários da Filial
        </a>
...
<div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-md p-8">
    ...
    <form action="{{ route('usuarios.updateFilial', Crypt::encrypt($user->id)) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end gap-4 mt-6">
            <a href="{{ route('usuarios.indexFilial', Crypt::encrypt($user->id_filial_id)) }}"

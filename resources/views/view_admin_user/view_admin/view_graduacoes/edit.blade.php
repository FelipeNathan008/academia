...
<div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-md p-8">
    ...
    <form action="{{ route('graduacoes.update', Crypt::encrypt($graduacao->id_graduacao)) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select
                    ...
                    <option
                        ...
                        {{ old('id_modalidade', $graduacao->id_modalidade) == $modalidade->id_modalidade ? 'selected' : '' }}>
                        {{ $modalidade->mod_nome }}
                    </option>
                    @endforeach
            ...
            <div>
                ...
                <input
                    type="text"
                    name="gradu_ordem"
                    value="{{ old('gradu_ordem', $graduacao->gradu_ordem) }}"
                    maxlength="60"
                    required
                    class="w-full border rounded-lg px-4 py-2 mt-1 focus:ring-2 focus:ring-[#8E251F] focus:outline-none"
                    placeholder="Ex: 1">

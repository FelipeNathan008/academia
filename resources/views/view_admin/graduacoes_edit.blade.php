    ...
    <form action="{{ route('graduacoes.update', $graduacao->id_graduacao) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="gradu_nome_cor" value="{{ old('gradu_nome_cor', $graduacao->gradu_nome_cor) }}" required
            ...
            <div>
                ...
                <input type="number" name="gradu_grau" value="{{ old('gradu_grau', $graduacao->gradu_grau) }}" required
                    class="w-full border rounded-lg px-4 py-2 mt-1 focus:ring-2 focus:ring-[#8E251F] focus:outline-none"
                    placeholder="Ex: 1">
            </div>
        </div>
